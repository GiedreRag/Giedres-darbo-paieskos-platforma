        ...
        <div className="container">
            <div className="row ">
                ...
                <form onSubmit={submitHandler} className="col-12 col-sm-8 col-md-6 col-lg-4">
                    ...
                    <button className="btn btn-primary py-2" type="submit">Pakeisti</button>
                    <Link className="btn btn-primary py-2" to="/koreguoti-forma/miestu-sarasas" type="submit">Atsaukti</Link>
                </form>
            </div>
        </div>
    );
